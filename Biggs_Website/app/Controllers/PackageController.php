...
class PackageController extends BaseController
{
	...
	public function createPackage()
	{
		...
		$branchName = $this->branchModel->find($branchId);

		$this->createGenericNotification(
			'New Package Added',
			"A new package {$packageName} has been added to {$branchName['title']}.",
			[],
			'broadcast',
			['branch_id' => $branchId, 'package_id' => $packageId],
			'package_update'
		);
	...
	public function updatePackage()
	{
		...
		$this->createGenericNotification(
			'Package Updated',
			"The package {$package['package_name']} has been updated. Please check the details for any changes.",
			[],
			'broadcast',
			['branch_id' => $package['branch_id'], 'package_id' => $packageId],
			'package_update'
		);
